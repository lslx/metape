...
//
//  Microsoft Research Detours Package, Version 3.0 Build_308.//merge by fhc update from ver 306 in dotnet src
//
...
{
	DWORD dwIdNew = GetCurrentProcessId();
    HANDLE hProcess = OpenProcess(PROCESS_ALL_ACCESS, 0, dwIdNew);
                           ...
                           PVOID *ppRealDetour)
{
	...
	/*
	// in the version  308,  not use this  , use 306 ver, above code
